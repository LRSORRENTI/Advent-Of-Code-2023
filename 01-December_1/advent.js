...
// console.log(sumCalibrationValues(document)); 
// Output will be 142
...
// console.log(sumCalibrationValues(adventInput))

const inputArray = adventInput.split('\n');


// PART TWO: 
function sumCalibrationValues(input) {
    const words = "one two three four five six seven eight nine 1 2 3 4 5 6 7 8 9".split(' ');
    let sum = 0;
...
sumCalibrationValues(inputArray);